...
export function Sidebar({ onSearchClick, onTodayClick, onToggleFocus, isFocusMode }: SidebarProps) {
  ...
  return (
    <aside className="w-64 h-screen border-r border-gray-200 flex flex-col relative overflow-hidden">
      <motion.div
        animate={{
          backgroundColor: activeWorkspace ? `${activeWorkspace.color}08` : '#ffffff',
        }}
